<%-- 
    Document   : update
    Created on : Nov 12, 2020, 1:34:52 PM
                ...
                <div class="card card-4">
                    <div class="card-body">
                        ...
                        <form action="update" method="post">
                            Product ID :<input type="text" name="pid" value="${Pr.productID}"><br>
                            Product Name: <input type="text" name="pname" value="${Pr.productName}"><br>
                            Supplier Name: 
                            <br><select name="sname"> 
                                <c:forEach items="${requestScope.sups}" var="s">
                                    <option 
                                        <c:if test="${s.supplierID eq Pr.supplier.supplierID }">
                                            selected="selected"
                                        </c:if>
                                        value="${s.supplierID}">${s.companyName}
                                    </option>
                                </c:forEach>
                            </select>
                            <br>
                            <br>
                            <br>
                            Quantity: <input type="text" name="quantity" value="${Pr.quantity}"><br>
                            Price: <input type="text" name="price" value="${Pr.price}"><br>
                            Number Of Import: <input type="text" name="noi" value="${Pr.numberOfImport}"><br>
                            Image: <input type="file" name="image" >

                            Category: 
                            <br><select name="cname"> 
                                <c:forEach items="${requestScope.cates}" var="c">
                                    <option <c:if test="${c.categoryID eq Pr.category.categoryID}">
                                            selected="selected"
                                        </c:if>
                            ...
                            <br>
                            <br>
                            Description: <input type="text" name="description" value="${Pr.description}">
                            <input style="padding: 10px; margin-top: 10px" type="submit" value="Save">
