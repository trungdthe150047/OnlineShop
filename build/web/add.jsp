<%-- 
    Document   : add
    Created on : Nov 11, 2020, 11:10:53 PM
                ...
                <div class="card card-4">
                    <div class="card-body">
                        ...
                        <form action="add" method="post">
                            ...
                            Number Of Import: <input type="text" name="noi"><br>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 col-12">
                            ...
                            <div class="single-footer about">
                                ...
                                <p class="call">Got Question? Call us 24/7<span><a href="tel:0387037855">0387 037 855</a></span></p>
                            </div>
                            <!-- End Single Widget -->
                        </div>
