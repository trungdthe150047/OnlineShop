<%-- 
    ...
    Created on : Nov 11, 2020, 11:41:04 PM
        ...
        <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
            ...
            <div class="card card-4">
                <div class="card-body" style="padding: 1rem">
                    <h2 class="title" style="text-align: center">List Product</h2>
                    <table border="1" style="border-collapse: collapse; padding: 20px; text-align: center">
                        ...
                        <c:forEach items="${requestScope.listP}" var="l">
                            <tr>
                                <td>${l.productID}</td>
                                <td>${l.productName}</td>
                                <td>${l.supplier.companyName}</td>
                                <td>${l.quantity}</td>
                                <td>${l.price}</td>
                                <td>${l.numberOfImport}</td>
                                <td>${l.numberOfSell}</td>
                                <td>${l.imagePath}</td>
                                <td>${l.category.categoryName}</td>
                                <td><button style="background-color: lightcyan; padding: 1px; border: 1px solid black"><a href="update?id=${l.productID}"><i class="fa fa-arrow-circle-up"></i></a></button></td>
                                <td><button onclick ="return confirm('Do you want to remove all?')" style="background-color: lightcyan; padding: 1px; border: 1px solid black"><a href="delete?id=${l.productID}"><i class="fa fa-trash"></i></a></button></td>
                            </tr>
                        </c:forEach>
                    </table>
                    <button style="width: 100%; border: 1px solid black; font-weight: bolder; padding: 10px; background-color: lightyellow"><a href="add">Add New Product</a></button>
                </div>
            </div>
